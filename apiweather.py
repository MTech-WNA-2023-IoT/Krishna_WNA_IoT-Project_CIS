...
#Configure MySQL
app.config['MYSQL_DATABASE_USER'] = 'krishna'
app.config['MYSQL_DATABASE_PASSWORD'] = 'KRISHNA'
app.config['MYSQL_DATABASE_DB'] = 'WeatherAPI'
...
#Execute the SQL
	cur.execute('select * from weather_data ORDER BY ID DESC LIMIT 2')
